...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        "<td>".$row["item_category"]. "<td>".$row["item_type"]. "<td>".$row["item_price"].
        "<td><a href=editByItemID.php?item_id=".$row["item_id"].">Edit</a></td>".
        "<td><a href=deleteByItemID.php?item_id=".$row["item_id"].">Rem/Disble</a></td>"."</tr>";
    }
} else {
    echo "0 results";
}
